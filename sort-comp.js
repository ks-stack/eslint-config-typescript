  ...
  create: Components.detect((context, components) => {
    ...
    function getRefPropIndexes(method) {
      ...
      methodsOrder.forEach((currentGroup, groupIndex) => {
        ...
        } else if (currentGroup === 'abstract-variables') {
          if (method.abstractVariables) {
            methodGroupIndexes.push(groupIndex);
          }
        } else if (currentGroup === 'abstract-methods') {
    ...
    function checkPropsOrder(properties) {
      const propertiesInfos = properties.map((node) => {
        if (node.type === 'TSAbstractClassProperty') {
          console.log(node)
        }
        return {
          ...
          abstractVariables: node.type === 'TSAbstractClassProperty' && !node.typeAnnotation,
          abstractMethod: node.type === 'TSAbstractClassProperty' && node.typeAnnotation,
